...
namespace UspgPOS.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Precio,Cantidad,MarcaId,ClasificacionesId")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long? id, [Bind("Id,Nombre,Precio,Cantidad,MarcaId,ClasificacionesId")] Productos productos)
        {
            if (id != productos.Id)
            {
                return NotFound();
